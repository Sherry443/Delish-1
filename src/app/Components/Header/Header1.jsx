          ...
          <div className="cs_top_header_in">
            <div className="cs_top_header_left header-info">
              <ul className="cs_top_nav d-flex flex-wrap align-items-center cs_fs_12 text-white m-0 p-0">
                <li><i className="bi bi-geo-alt-fill"></i>Defence Road, Kahna Flyover Near Soneri Bank Lahore</li>
          ...
          <div className="cs_main_header_in">
            <div className="cs_main_header_left">
              <Link className="cs_site_branding" href="/">
                <Image src="/assets/img/logo/logo-del.png" alt="img" width={197} height={58}   />
              </Link>
              </div>
            ...
            <div className="cs_main_header_right">
              ...
              {/* <a onClick={() => setSearchToggle(!searchToggle)} className="search-trigger search-icon"><i className="bi bi-search"></i></a> */}
                ...
                <Link href="/contact" className="theme-btn" >FOR QUERRIES<i className="bi bi-arrow-right"></i></Link>
                  </div>
