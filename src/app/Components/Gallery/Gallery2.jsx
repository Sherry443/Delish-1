...
const Gallery2 = () => {
    ...
    const brandContent = [
        ...
        {img:'/assets/img/gallery/Food.png', addclass:'col-lg-4'},
        {img:'/assets/img/gallery/certificate.png', addclass:'col-lg-4'},
        {img:'/assets/img/gallery/1.png',addclass:'col-lg-4'},
        {img:'/assets/img/gallery/2.png',addclass:'col-lg-4'},
        {img:'/assets/img/gallery/3.png',addclass:'col-lg-4'},
        {img:'/assets/img/gallery/4.png',addclass:'col-lg-4'},
