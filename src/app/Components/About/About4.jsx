...
const About4 = () => {
    ...
    const aboutContent = {  
        ...
        img2:'/assets/img/shape/right.webp',  
        img3:'/assets/img/shape/aboutShape1_4.png',  
        img4:'/assets/img/shape/left.webp',  

        title:'Our Trusted Collaborations',
        content:'We proudly partner with leading companies to bring you innovative solutions and unmatched quality.Each collaboration reflects our commitment to excellence and shared vision for the future.',  
        btnName:'ORDER NOW', 
        btnUrl:'/menu', 
      } 
